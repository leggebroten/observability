defmodule Observability.PromEx do
  @moduledoc """
  This was automatically generated. https://hexdocs.pm/prom_ex/readme.html#setting-up-promex
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule ObservabilityWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: Observability.PromEx
  ...
  use PromEx, otp_app: :observability
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: ObservabilityWeb.Router, endpoint: ObservabilityWeb.Endpoint},
      Plugins.Ecto
      # Plugins.Oban,
      ...
      # Observability.Users.PromExPlugin
    ]
  end
  ...
  def dashboard_assigns do
    [
      datasource_id: "observability_demo",
